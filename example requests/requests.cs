...
var client = new RestClient("https://foto.munchmuseet.no/fotoweb/archives/5026-Malerier");
client.Timeout = -1;
var request = new RestRequest(Method.GET);
...
var client = new RestClient("https://foto.munchmuseet.no/fotoweb/archives/5026-Malerier/Arkiv/M0112_20190403.tif.info");
client.Timeout = -1;
var request = new RestRequest(Method.GET);
...
var client = new RestClient("https://foto.munchmuseet.no/fotoweb/archives/5026-Malerier/?105=vampire");
client.Timeout = -1;
var request = new RestRequest(Method.GET);
request.AddHeader("Accept", "application/vnd.fotoware.assetlist+json");
IRestResponse response = client.Execute(request);
